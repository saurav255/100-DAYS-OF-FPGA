...
HD_PWD='C:/fpga_series/boolean_fn/boolean_fn.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bool_fn.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bool_fn.tcl -notrace
