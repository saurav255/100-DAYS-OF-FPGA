...
HD_PWD='C:/fpga_series/boolean_fn/boolean_fn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bool_fn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bool_fn.tcl
