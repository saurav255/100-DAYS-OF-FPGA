...
HD_PWD='C:/fpga_series/bintogray/bintogray.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bintogray.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bintogray.tcl -notrace
