...
HD_PWD='C:/fpga_series/bintogray/bintogray.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bintogray.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bintogray.tcl
