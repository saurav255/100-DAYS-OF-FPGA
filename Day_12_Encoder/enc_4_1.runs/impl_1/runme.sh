...
HD_PWD='C:/fpga_series/enc_4_1/enc_4_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_4_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source enc_4_2.tcl -notrace
