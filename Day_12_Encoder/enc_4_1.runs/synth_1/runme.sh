...
HD_PWD='C:/fpga_series/enc_4_1/enc_4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_4_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enc_4_2.tcl
