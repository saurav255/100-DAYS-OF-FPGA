...
HD_PWD='C:/fpga_series/tally_counter/tally_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tally_ctr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tally_ctr.tcl
