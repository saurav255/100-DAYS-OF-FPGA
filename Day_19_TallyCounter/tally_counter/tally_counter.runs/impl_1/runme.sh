...
HD_PWD='C:/fpga_series/tally_counter/tally_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tally_ctr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tally_ctr.tcl -notrace
