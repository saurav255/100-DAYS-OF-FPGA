...
HD_PWD='C:/fpga_series/adder/adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_8_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_8_bit.tcl -notrace
