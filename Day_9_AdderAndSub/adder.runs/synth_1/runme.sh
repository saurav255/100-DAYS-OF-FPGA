...
HD_PWD='C:/fpga_series/adder/adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_8_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_8_bit.tcl
