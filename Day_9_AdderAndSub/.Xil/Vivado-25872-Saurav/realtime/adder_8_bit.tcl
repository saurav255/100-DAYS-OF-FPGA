...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/fpga_series/adder/.Xil/Vivado-25872-Saurav/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog C:/fpga_series/adder/adder.srcs/sources_1/new/adder_8_bit.v
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification false
    set rt::top adder_8_bit
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "C:/fpga_series/adder/.Xil/Vivado-25872-Saurav/"
