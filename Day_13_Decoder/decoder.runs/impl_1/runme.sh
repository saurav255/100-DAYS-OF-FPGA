...
HD_PWD='C:/fpga_series/decoder/decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dec_2_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dec_2_4.tcl -notrace
