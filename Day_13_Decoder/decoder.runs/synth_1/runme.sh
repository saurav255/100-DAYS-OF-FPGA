...
HD_PWD='C:/fpga_series/decoder/decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dec_2_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dec_2_4.tcl
