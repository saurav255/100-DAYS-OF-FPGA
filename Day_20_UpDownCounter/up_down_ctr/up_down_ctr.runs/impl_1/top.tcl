namespace eval ::optrace {
  variable script "C:/fpga_series/up_down_ctr/up_down_ctr.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/fpga_series/up_down_ctr/up_down_ctr.cache/wt [current_project]
  set_property parent.project_path C:/fpga_series/up_down_ctr/up_down_ctr.xpr [current_project]
  set_property ip_output_repo C:/fpga_series/up_down_ctr/up_down_ctr.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/fpga_series/up_down_ctr/up_down_ctr.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/fpga_series/up_down_ctr/up_down_ctr.srcs/constrs_1/new/constr.xdc
