...
HD_PWD='C:/Vivado_Projects/ctr_16_bit/ctr_16_bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ctr_4_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ctr_4_bit.tcl -notrace
