...
HD_PWD='C:/Vivado_Projects/ctr_16_bit/ctr_16_bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ctr_4_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ctr_4_bit.tcl
