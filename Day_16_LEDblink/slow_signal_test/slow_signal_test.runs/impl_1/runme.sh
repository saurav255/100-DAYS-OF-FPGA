...
HD_PWD='C:/fpga_series/slow_signal_test/slow_signal_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log slow_sig.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source slow_sig.tcl -notrace
