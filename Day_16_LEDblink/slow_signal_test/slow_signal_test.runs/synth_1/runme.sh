...
HD_PWD='C:/fpga_series/slow_signal_test/slow_signal_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log slow_sig.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source slow_sig.tcl
