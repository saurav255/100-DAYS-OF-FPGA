...
HD_PWD='C:/fpga_series/rising_edge_counter/rising_edge_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rising_edge_ctr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rising_edge_ctr.tcl -notrace
