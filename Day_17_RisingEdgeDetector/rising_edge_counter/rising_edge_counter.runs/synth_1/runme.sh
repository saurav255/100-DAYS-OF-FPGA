...
HD_PWD='C:/fpga_series/rising_edge_counter/rising_edge_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rising_edge_ctr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rising_edge_ctr.tcl
