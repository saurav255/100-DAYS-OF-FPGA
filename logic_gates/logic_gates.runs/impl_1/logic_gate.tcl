namespace eval ::optrace {
  variable script "C:/fpga_series/logic_gates/logic_gates.runs/impl_1/logic_gate.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/fpga_series/logic_gates/logic_gates.cache/wt [current_project]
